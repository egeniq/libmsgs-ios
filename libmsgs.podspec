#
#  Be sure to run `pod spec lint libmsgs.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/egeniq/libmsgs-ios.git", :tag => s.version }
